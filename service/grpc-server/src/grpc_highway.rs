...
/// Represents a transaction payload for gRPC/Protobuf communication in the highway ecosystem.
/// Used for transaction routing between cascade-router -> highway-gateway -> highway instances.
